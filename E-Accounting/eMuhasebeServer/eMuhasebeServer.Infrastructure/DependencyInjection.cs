...
namespace eMuhasebeServer.Infrastructure
{
    public static class DependencyInjection
    {
        public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddScoped<ICacheService, MemoryCacheService>(); // bunlar memorycacheservice için
            //services.AddSingleton<IConnectionMultiplexer>(ConnectionMultiplexer.Connect("localhost"));
            //services.AddScoped<ICacheService, RedisCacheService>(); bunlar rediscacheservice için dockerdaki serverin çalışması lazım
