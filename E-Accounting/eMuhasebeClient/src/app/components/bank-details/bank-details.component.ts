...
export class BankDetailsComponent {
  ...
  create(form: NgForm){
    if(form.valid){
        ...
        this.createModel.recordType = +this.createModel.recordType
  ...
  deleteById(model: BankDetailModel){
    this.swal.callSwal("Banka Hareketini Sil?",`${model.date} tarihteki ${model.description} açıklamalı banka hareketini silmek istiyor musunuz?`,()=> {
